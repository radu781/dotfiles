...
package.path = "C:\\Users\\Radu\\.config\\wezterm".. package.path
...
local config = {
	...
	color_scheme_dirs = { "C:\\Users\\Radu\\.config\\wezterm\\colors"},
...
config.background = {
    {
        source = {
            File = "C:\\Users\\Radu\\Pictures\\wallpapers\\fantasy\\moonlit_shore.jpg"
        },
        hsb = {
            brightness = 0.1
        }
